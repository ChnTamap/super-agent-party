...
const translations = {
    'zh-CN': {
        ...
        'outputLength': '输出长度',
        'stopWords': '停止词',
        'stopWordsPlaceholder': '输入推理模型输出停止词，多个词之间用逗号隔开',
...
key3`,
        ...
        'goToExtensionPage': '前往扩展页面',
        'getPlugin': '查看插件列表',
        'getPluginInstructions': '请输入插件的github仓库URL或者直接上传本地的zip包，点击',
    },
    'en-US': {
        'chat': 'Chat',
        ...
        'stopWordsPlaceholder': 'Input stop words, separated by commas',
...
Key3`,
        ...
        'goToExtensionPage': 'Go to Extension Page',
        'getPlugin': 'to view the plugin list',
        'getPluginInstructions': 'Please enter the GitHub repository URL of the plugin or directly upload a local zip package. Click',
    },
  };
