...
key3`,
        ...
        'saturday': '周六',
        'sunday': '周日',
        'noInputLatency': '无输入延迟(秒)',
        'actionType': '执行类型',
        'prompt': '提示词',
        'promptPlaceholder': '请输入提示词内容',
        'removeBehavior': '删除行为',
      ...
      'bodyPlaceholder': `Enter the body in JSON Schema format. For example:
{
    ...
    "required": ["name", "age"]
        ...
        'enabledInterruption': "Enable Interruption(When turned on, if the microphone is too close to the speaker, it will cause the model's voice to interrupt itself)",
...
Key3`,
        ...
        'saturday': 'Saturday',
        'sunday': 'Sunday',
        'noInputLatency': 'No Input Latency(seconds)',
        'actionType': 'Action Type',
        'prompt': 'Prompt',
        'promptPlaceholder': 'Please enter prompt content',
